            ...
            >
              ...
              <div className="relative">
                <motion.input
                  ...
                  className="w-full px-4 py-2 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 border-transparent rounded-xl focus:outline-none focus:border-modern-coral transition-all duration-300 peer placeholder-transparent text-gray-900 dark:text-gray-100"
                  placeholder="Name"
                ...
                <motion.label
                  ...
                  className={`absolute left-6 transition-all duration-300 pointer-events-none ${
                    focusedField === "name" || formData.name
                      ? "-top-4 text-xs bg-white dark:bg-gray-800 px-2 text-modern-coral font-semibold"
              ...
              <div className="relative">
                <motion.input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full px-4 py-2 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 border-transparent rounded-xl focus:outline-none focus:border-modern-teal transition-all duration-300 peer placeholder-transparent text-gray-900 dark:text-gray-100"
                  placeholder="Email"
                  whileFocus={{ scale: 1.02 }}
                />
                <motion.label
                  ...
                  className={`absolute left-6 transition-all duration-300 pointer-events-none ${
                    focusedField === "email" || formData.email
                      ? "-top-4 text-xs bg-white dark:bg-gray-800 px-2 text-modern-teal font-semibold"
                      : "top-2 text-gray-500 dark:text-gray-400"
                  }`}
                >
                  Your Email
              ...
              <div className="relative">
                <motion.textarea
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full px-4 py-2 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 border-transparent rounded-xl focus:outline-none focus:border-vintage-sage transition-all duration-300 resize-none peer placeholder-transparent text-gray-900 dark:text-gray-100"
                  placeholder="Message"
                  whileFocus={{ scale: 1.02 }}
                />
                <motion.label
                  ...
                  className={`absolute left-6 transition-all duration-300 pointer-events-none ${
                    focusedField === "message" || formData.message
                      ? "-top-4 text-xs bg-white dark:bg-gray-800 px-2 text-vintage-sage font-semibold"
                      : "top-2 text-gray-500 dark:text-gray-400"
                  }`}
                >
                  Your Message
